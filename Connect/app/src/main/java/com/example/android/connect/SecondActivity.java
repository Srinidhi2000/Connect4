...
public class SecondActivity extends AppCompatActivity {
    ...
    int checkrun = 0;
    int xcoord, ycoord;
    float toballx, tobally;
    int b1, b2, b3, b4;
    int colno, rowno, ballcolor, ballno = -1;
    int numundo = 0;
    int[][] a = new int[7][8];
    int cnt = 0;
    float positiony, positionx;
    int moveno = 0;
    TranslateAnimation t,s;
    int over = 0, status = 0;
                            ...
                            for (int i = 0; i < 42; i++) {
                                if (checkinside(event.getX(), event.getY(), ballview.getpositionx(i), ballview.getpositiony(i), ballview.getradius(), ballview.getcolumnno(i))) {
                                    ...
                                    if (positiony != 0) {
                                        ...
                                        t=new TranslateAnimation(Animation.ABSOLUTE,0.0f,Animation.ABSOLUTE,positionx-b[moveno].x,
                                        Animation.ABSOLUTE,0.0f,Animation.ABSOLUTE,0.0f);
                                        s= new TranslateAnimation(Animation.ABSOLUTE,0.0f,Animation.ABSOLUTE,0.0f,Animation.ABSOLUTE,0.0f,Animation.ABSOLUTE,positiony-10);
                                        t.setDuration(500);
                                        s.setStartOffset(500);
                                        s.setDuration(500);
                                        AnimationSet animationSet=new AnimationSet(true);
                                        animationSet.addAnimation(t);
                                        animationSet.addAnimation(s);
                                        b[moveno].startAnimation(animationSet);
                                        checkrun = 1;
